...
class TextProcessor:
    ...
    def convert_to_bag_of_words(self, list_of_lists, min_freq=10, max_freq_ratio=0.05):
        ...
        vocabulary = sorted(word for word, count in word_freq.items() if min_freq <= count < max_freq)
    ...
    def worker(self, data_chunk):
        ...
        for sentence in data_chunk:
            ...
            lemmatized_words = [lemmatizer.lemmatize(word, self.get_wordnet_pos(word)) for word in words if
